...
<c:if test="${fn:contains(sessionInfo.resourceList, '/school/edit')}">
	<script type="text/javascript">
		$.canEdit = true;
	</script>
</c:if>
<c:if test="${fn:contains(sessionInfo.resourceList, '/school/delete')}">
	<script type="text/javascript">
		$.canDelete = true;
	</script>
</c:if>
<c:if test="${fn:contains(sessionInfo.resourceList, '/school/view')}">
	<script type="text/javascript">
		$.canView = true;
	</script>
</c:if>
...
<script type="text/javascript">
	...
	function addFun() {
		location.href = "${ctx}/school/addPage";
	}
	...
	function editFun(id) {
		...
		location.href='${ctx}/school/editPage?uuid=' + id
	}
	...
	function viewFun(id) {
		...
		parent.$.modalDialog({
			...
			width : 800,
			height : 600,
			href : '${ctx}/school/viewPage?uuid=' + id
		});
	}
