...
<script type="text/javascript">
	...
	function submit() {
		...
		alert(editor.html());
		var myform = $("#newsEditForm");
		myform.attr("action", "${ctx}/news/edit");
		myform.submit();
	}
			...
			<table class="grid">
				<tr>
					...
					<td><input id="fuID" name="fuID" type="hidden"
						value="${tnews.fuID}" /> <input name="ftitle" type="text"
						value="${tnews.ftitle}" placeholder="请输入文章标题"
				...
				<tr>
					...
					<td><textarea name="ftag" rows="3" cols="80"
							...
							data-options="required:true">${tnews.ftag}</textarea></td>
				</tr>
				<tr>
					<td>文章分类</td>
				...
				<tr>
					<td>文章图片</td>
					<td><input type="text" id="fimagesurl" name="fimagesurl"
						value="${tnews.fimagesurl}" style="width:450px;height: 25px;" />
						<a href="javascript:void(0)" id="upimage"
						class="easyui-linkbutton">上传图片</a></td>
				</tr>
				<tr>
					<td>文章内容</td>
					<td><textarea id="fcontent" name="fcontent" cols="110"
							rows="20">${tnews.fcontent}</textarea></td>
				</tr>
				<tr>
					<td></td>
