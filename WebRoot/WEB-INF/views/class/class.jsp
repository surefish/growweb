...
<c:if test="${fn:contains(sessionInfo.resourceList, '/news/view')}">
	<script type="text/javascript">
		$.canView = true;
	</script>
</c:if>
...
<script type="text/javascript">
	...
	function addFun() {
		location.href = "${ctx}/class/addPage";
	}
	...
	function editFun(id) {
		...
		location.href='${ctx}/class/editPage?uuid=' + id
	}
	...
	function viewFun(id) {
		...
		parent.$.modalDialog({
			...
			width : 800,
			height : 600,
			href : '${ctx}/class/viewPage?uuid=' + id
		});
	}
...
<body class="easyui-layout" data-options="fit:true,border:false">
	...
	<div id="toolbar" style="display: none;">
		<c:if test="${fn:contains(sessionInfo.resourceList, '/class/add')}">
