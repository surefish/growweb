...
<div style="padding: 3px;">
	<form id="newsclassAddForm" method="post">
		<table class="grid">
			<tr>
				<td>分类名称</td>
			...
			<tr>
				<td>备注</td>
				<td><input name="fmemo" type="text" placeholder="请输入备注" class="easyui-validatebox" data-options="required:true" ></td>
			</tr>
			<tr>
				<td>图标</td>
			...
			<tr>
				<td>图片地址</td>
				<td colspan="3"><input  name="furl" style="width: 300px;"/></td>
			</tr>
		</table>
	</form>
</div>