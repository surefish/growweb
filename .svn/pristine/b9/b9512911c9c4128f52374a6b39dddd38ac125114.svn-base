...
<script type="text/javascript">
	...
	var sessionInfo_resourceList = '${sessionInfo.resourceList}';
	...
	function addTab(params) {
		var iframe = '<iframe src="'
				+ params.url
				+ '" frameborder="0" scrolling="auto" style="border:0;width:100%;height:99.5%;"></iframe>';
		var t = $('#index_tabs');
		var opts = {
			title : params.title,
			closable : true,
...
<body>
	...
	<div id="index_layout">
		<div data-options="region:'north',border:false"
			...
			<div id="header">
				<span style="float: right; padding-right: 20px;"> 欢迎 <b>${sessionInfo.name}</b>
					...
					onclick="changeThemeFun('default')" style="color: #fff">更换皮肤</a>
					...
					</div> &nbsp;&nbsp; <a href="javascript:void(0)" onclick="editUserPwd()"
					style="color: #fff">修改密码</a> &nbsp;&nbsp; <a
		...
		<div data-options="region:'south',border:false"
			style="height: 30px;line-height:30px; overflow: hidden;text-align: center;background-color: #eee">版权所有@LUCKYBABY
		</div>
	</div>
