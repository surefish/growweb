...
<div style="padding: 3px;">
	<form id="resourceEditForm" method="post">
		<table  class="grid">
			...
			<tr>
				<td>备注</td>
				<td colspan="3"><input name="description" type="text" value="${resource.description}" placeholder="请输入备注" class="easyui-validatebox span2" data-options="width:140,height:29" ></td>
			</tr>
		</table>
	</form>
</div>
